...
public class SnakkingPrototyp {
	...
	public static void main(String[] args) {
		...
		System.out.print("Smisk: ");
		smisk = Integer.valueOf(kb.nextLine().trim());
		System.out.print("Skrem: ");
		skrem = Integer.valueOf(kb.nextLine().trim());
		System.out.print("Bløff: ");
		bløff = Integer.valueOf(kb.nextLine().trim());
		
		Spiller spiller = new Spiller(skrem, smisk, bløff, 0,0,0);
		Vakt vakt = new Vakt();
